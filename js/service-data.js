const servicesData = [
    {
        ...
        additionalInfo: {
            ...
            includes: ['Все материалы включены', 'Чай/кофе', 'Сертификат участника'],
            schedule: 'Вторник и четверг: 18:00-20:00, Суббота: 12:00-14:00',
            requirements: 'Опыт не требуется, подходит для начинающих. Возрастное ограничение: 14+'
        }
    },
    {
        ...
        additionalInfo: {
            ...
            includes: ['Все необходимые материалы', 'Профессиональное руководство', 'Напитки и легкие закуски', 'Фотосессия с вашими работами'],
